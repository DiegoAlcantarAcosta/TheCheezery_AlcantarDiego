...
class ProductosActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val imgCategoria: ImageView = findViewById(R.id.imgCategoria) // Referencia al ImageView

        val categoria = intent.getStringExtra("categoria")

        val productosMostrar = when (categoria) {
            "ColdDrinks" -> {
                imgCategoria.setImageResource(R.drawable.colddrinks) // Cambia la imagen
                coldDrinks
            }
            "HotDrinks" -> {
                imgCategoria.setImageResource(R.drawable.hotdrinks)
                hotDrinks
            }
            "Sweets" -> {
                imgCategoria.setImageResource(R.drawable.sweets)
                sweets
            }
            "Salties" -> {
                imgCategoria.setImageResource(R.drawable.salties)
                salties
            }
            else -> ArrayList()
        }
    ...
    private class AdaptadorProductos : BaseAdapter {
        ...
        override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
            ...
            var descripcion = vista.findViewById(R.id.producto_descripçion) as TextView
